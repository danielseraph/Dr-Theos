...
export const RegistrationCTA = () => {
  return (
    <section className="relative py-32 bg-navy overflow-hidden">
      ...
      <div className="absolute -bottom-24 -left-24 w-96 h-96 bg-gold/20 rounded-full blur-[100px] pointer-events-none" />
      ...
      <div className="max-w-4xl mx-auto px-6 relative z-10 text-center">
        ...
        <Link to="/register">
          <Button variant="primary" size="lg" className="px-12 text-lg shadow-xl shadow-gold/20">
            REGISTER NOW
          </Button>
        </Link>
      </div>
