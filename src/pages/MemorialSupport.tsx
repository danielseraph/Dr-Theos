...
import { Heart, Users, BookOpen, Briefcase, Activity, GraduationCap } from 'lucide-react';
    ...
    <div className="w-full pt-20">
      ...
      <section className="bg-navy text-white py-24 px-6 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto relative z-10 text-center">
          ...
          >
            <span className="text-gold font-semibold uppercase tracking-widest text-sm">Memorial Impact</span>
          </motion.div>
          <motion.h1 
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          >
            One-Year Memorial Support Initiative
          </motion.h1>
          <motion.p 
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          >
            In loving memory of Dr. Theo's mother, a massive empowerment drive was held to uplift members of the community across education, business, and vocational training.
          </motion.p>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
            <div>
              ...
              <p className="text-lg text-dark/80 mb-6 leading-relaxed">
                This memorial initiative successfully reached <strong>56 individuals</strong>, providing targeted support where it was needed most. 
              </p>
      ...
      <section className="py-24 bg-offwhite px-6">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-bold text-navy mb-4">Detailed Breakdown of Support</h2>
            <p className="text-lg text-dark/70">A transparent look at how the funds were distributed to empower the community.</p>
          </div>
